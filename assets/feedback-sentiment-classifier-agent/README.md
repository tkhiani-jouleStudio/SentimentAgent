...
An AI agent that classifies free-text feedback as positive, negative, or neutral and returns a structured result with sentiment label and confidence score.
